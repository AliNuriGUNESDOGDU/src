...
def gripper_client(value,link):
    ...
    while d < 50.0:
        x_change = 0.5*amplitude*math.sin(angle)
        #y_change = y_kp*amplitude*math.sin(angle)
        z_change = 0.6*amplitude*math.sin(angle)
        ...
        q4 = q4_init+q3_init+q2_init-q2-q3+math.copysign(1,math.sin(angle))*q_comp_xz
        q5 = q5_init+math.copysign(1,math.sin(angle))*q_comp_y
        q6 = q6_init
