...
class PickPlace(object):
    ...
    def state_machine(self):
        ...
        q_wait = [2.37,0.98,-2.04,-1.15,-1.57,-1.57]
        q_before_pick = [2.32,0.46,-0.94,-1.10,-1.57,-0.88]
        q_go_pick = [2.34,0.50,-0.76,-1.33,-1.57,-0.88]
        q_pick = [2.34,0.50,-0.76,-1.33,-1.55,-0.88]
        q_after_pick = q_before_pick
        q_show = [1.99,0.89,-0.95,-3.11,-2.02,-1.59]
        q_before_release = [0.56,0.46,-0.94,-1.10,-1.57,-2.46]
        q_release = [0.56,0.50,-0.76,-1.33,-1.57,-2.46]
...
if __name__ == '__main__':
    try:
        ...
        q1 = [0.56,0.50,-0.76,-1.33,-1.57,-2.46]
